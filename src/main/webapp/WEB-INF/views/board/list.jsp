					...
					<div class="col-lg-12">
						<form action="/board/list" id="searchForm" method="get">
							<select name="type">
								...
								<option value="TW" <c:out value="${pageMaker.cri.type== 'TW' ?'selected':''}" />>제목 or 글쓴이</option>
...
$(document).ready(function() {
	...
	document.querySelector('#searchForm input[name=keyword]').addEventListener("keyup", function(e) {
		e.preventDefault();
		if (e.keyCode ==13) {
			searchFunction(e);
		}	
	...
	//뒤로가기나 앞으로가기로 현재 페이지에 왔을 경우 checkModal에서 걸러낸다
